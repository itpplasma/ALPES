...
# Example usage:
magnet = MagnetDesign()
print(magnet.B_middle)
# B-field specifications
B_middle = float(87.3/1000) # T
...
minor_radius_plasma = float(0.08) #meter

# coil assumptions
number_of_coils_per_circuit = int(10)
number_of_circuits = int(4)
number_of_windings_x = int(3)
number_of_windings_y = int(4)
max_current_per_mm_2 = float(50000000.) #A/m² 
specific_resistance = float(0.) #
major_winding_radius = float(0.16) #m
winding_radius = float(0.0015) #  ###elefant
cooling_radius = float(0.002) # cooling coil + winding coil ###elefant
...
radius_within = float(0.) #mm available space within torus
total_circumference_of_coils_within = float(0.) #mm
