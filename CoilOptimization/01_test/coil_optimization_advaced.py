...
from simsopt.geo import (
    ...
    MeanSquaredCurvature, LpCurveCurvature, CurveSurfaceDistance, LinkingNumber, curves_to_vtk, plot)
...
filename = 'Design_Example/input/serial0021326.json'
...
surfaces, B_axis, coils = simsopt.load(filename)
s = surfaces[-1]
